...
namespace CRMTicariOtomasyon.Controllers
{
    public class İstatistikController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var deger13 = c.Uruns.Where(u => u.Urunid == (c.SatisHarekets.GroupBy(x => x.Urunid).OrderByDescending(z => z.Count()).Select(y => y.Key).FirstOrDefault())).Select(s => s.UrunAd).FirstOrDefault();
            ViewBag.d13 = deger13;
